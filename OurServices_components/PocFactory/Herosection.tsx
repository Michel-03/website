      ...
      <div className="lg:max-w-[75%] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full md:w-1/2 text-left">
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-light text-gray-400 leading-snug">
            Rapid AI  <span className="text-teal-600 text-4xl font-bold"> Proof of Concept</span>
            {/* <h2 className="text-lg text-gray-500 font-bold mt-2">We are hiring !</h2> */}
            <p className="text-sm text-gray-500 mt-2">PoCs provide a practical, low-risk way to test AI solutions in real-world scenarios. They allow teams to assess performance, capture learnings, and confidently decide whether to invest in full-scale development.</p>
            {/* <p className="text-lg text-gray-500 font-thin mt-2">Byte Analytics AI Scoping Programme de-risks your investment in AI and validates project feasibility before moving to development.</p> */}
          </h1>
