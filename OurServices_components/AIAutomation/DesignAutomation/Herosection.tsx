      ...
      <div className="lg:max-w-[75%] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full md:w-1/2 text-left">
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-light text-gray-400 leading-snug">
            Design Process <span className="text-teal-600 text-4xl font-bold"> Automation</span>
            {/* <h2 className="text-lg text-gray-500 font-bold mt-2">We are hiring !</h2> */}
            <p className="text-sm text-gray-500 mt-2">Design isn’t just a creative process, it’s an industrial practice that enables companies across several sectors to continuously enhance the quality of their products or create personalized objects that meet the needs of their customers.</p>
            <p className="text-sm text-gray-500 font-thin mt-2">Artificial Intelligence can be applied to automate the design process, allowing creatives to focus only on the aesthetics of a product without worrying about technical constraints that are already taken into account by the model performing the design task.
