      ...
      <div className="lg:max-w-[75%] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full md:w-1/2 text-left">
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-light text-gray-400 leading-snug">
            ...
            <p className="text-xs text-gray-500 font-thin mt-2">These questions are designed to provide Byte Analytics clients with a greater understanding of our business. For more information on any of the points below, please contact us.</p>
          </h1>
