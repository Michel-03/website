      ...
      <div className="lg:max-w-[75%] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full md:w-1/2 text-left">
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-light text-gray-400 leading-snug">
            ...
            <p className="text-lg text-gray-500 font-thin mt-2">Around 85% of AI projects fail to transition from experimentation to production.</p>
            <p className="text-lg text-gray-500 font-thin mt-2">Our AI Scoping Programme de-risks AI investment by confirming feasibility before development.</p>
          </h1>
