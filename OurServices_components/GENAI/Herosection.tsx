      ...
      <div className="lg:max-w-[75%] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full md:w-1/2 text-left">
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-light text-gray-400 leading-snug">
            <span className="text-teal-500 font-bold">Applied Generative AI </span> for Organizations
            {/* <h2 className="text-lg text-gray-500 font-bold mt-2">We are hiring !</h2> */}
            <p className="text-sm text-gray-500 font-thin mt-2">Generative AI allows businesses to create, analyze, and automate content at scale. From content creation and answer generation to information extraction and creative design, GenAI reduces manual effort while unlocking new ideas and efficiencies..</p>
          </h1>
