      ...
      <div className="lg:max-w-[75%] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full md:w-1/2 text-left">
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-light text-gray-400 leading-snug">
            <span className="text-teal-500 font-bold">Agnostic AI</span> Infrastructure
            {/* <h2 className="text-lg text-gray-500 font-bold mt-2">We are hiring !</h2> */}
            <p className="text-sm text-gray-500 font-thin mt-2">A vendor-agnostic AI infrastructure ensures flexibility, future-readiness, and freedom from lock-in. Organizations adopting this approach stay ahead of competitors by continuously leveraging the best AI technologies. Through targeted LLM selection, RAG, and domain-specific fine-tuning, we achieve enterprise-grade accuracy tailored to your business.</p>
          </h1>
