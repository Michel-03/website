      ...
      <div className="lg:max-w-[75%] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full md:w-1/2 text-left">
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-light text-gray-400 leading-snug">
            Artificial Intelligence in <span className="text-teal-600 text-2xl font-bold">Marketing</span> 
            {/* <h2 className="text-lg text-gray-500 font-bold mt-2">Artificial Intelligence Applied in the Construction Industry</h2> */}
            <p className="text-sm text-gray-500 mt-2">Modern marketing relies on an in-depth understanding of customer needs and preferences, and then the ability to act on that knowledge quickly and effectively. The ability to make real-time, data-driven decisions has brought AI to the forefront for marketing stakeholders.</p>
            <p className="text-sm text-gray-500 font-thin mt-2">AI brings an opportunity for a dynamic and hyper-personalized marketing strategy, reducing the amount of unpleasant and pushy adverts and delivering customer-centric, quality brand experience, increased campaign performance and greater efficiency of your marketing operations.
            </p>
          </h1>
